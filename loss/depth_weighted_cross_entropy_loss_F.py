...
class DepthWeightedCrossEntropyLossF(CrossEntropyLoss):
    def __init__(
        self,
        ...
        **_,
        ...
        antiproportional based on the depth of the token: fx(d) = 1 / d.
        ...
        """
        super(DepthWeightedCrossEntropyLossF, self).__init__(weight, size_average, ignore_index, None, 'none')
