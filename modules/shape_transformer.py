...
class ShapeTransformer(pl.LightningModule):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        elif embedding == 'single_conv':
            embedding = SingleConvolutionalEmbedding(embed_dim, spatial_dim)
        ...
        elif head == 'single_conv':
            head = SingleConvolutionalHead(num_vocab, embed_dim, spatial_dim)
