...
class SingleConvolutionalEmbeddingF(nn.Module):
    def __init__(self, num_vocab, embed_dim, resolution, spatial_dim):
        ...
        """
        super(SingleConvolutionalEmbeddingF, self).__init__()
        ...
        # convolutions
        s = 2**spatial_dim
        self.value_convolution = nn.Conv1d(1, embed_dim, kernel_size=s, stride=s)
    ...
    def source(self, value, depth, position):
        ...
        x = self.value_convolution(value.unsqueeze(1))  # [N, E, T']
