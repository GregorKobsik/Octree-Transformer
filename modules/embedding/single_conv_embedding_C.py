...
class SingleConvolutionalEmbeddingC(nn.Module):
    def __init__(self, num_vocab, embed_dim, resolution, spatial_dim):
        ...
        """
        super(SingleConvolutionalEmbeddingC, self).__init__()
    ...
    def source(self, value, depth, position):
        ...
        return x + self._embed_depth_position(depth, position)  # [N, S, E]
    ...
    def target(self, value, depth, position):
        ...
        x = x + self._embed_depth_position(depth, position)  # [N, T, E]
