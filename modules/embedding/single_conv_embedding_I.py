...
class SingleConvolutionalEmbeddingI(nn.Module):
    def __init__(self, num_vocab, embed_dim, resolution, spatial_dim):
        ...
        """
        super(SingleConvolutionalEmbeddingI, self).__init__()
        ...
        # layers
        layers = []
        layers.append(nn.Conv1d(e_dim, embed_dim, kernel_size=self.chunk_size, stride=self.chunk_size))
    ...
    def _convolute(self, x):
        ...
        return self.convolution(x.transpose(1, 2)).transpose(1, 2)
